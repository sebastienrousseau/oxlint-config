...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@sebastienrousseau/oxlint-config"><img src="https://img.shields.io/npm/v/%40sebastienrousseau%2Foxlint-config.svg?style=for-the-badge&color=fc8d62&logo=npm" alt="npm package" /></a>
  <a href="https://sebastienrousseau.com/oxlint-config/"><img src="https://img.shields.io/badge/docs-sebastienrousseau.com-brightgreen.svg?style=for-the-badge&logo=github" alt="Documentation" /></a>
  ...
  <a href="https://www.bestpractices.dev/projects/14514"><img src="https://img.shields.io/cii/level/14514?style=for-the-badge&label=OpenSSF%20Best%20Practices&logo=openssf" alt="OpenSSF Best Practices" /></a>
...
- [Ultra-Fast Rust Linting Rules](#ultra-fast-rust-linting-rules) — before and after rule comparison
...
Install `@sebastienrousseau/oxlint-config` as a development dependency:
...
oxlint takes its configuration file path on the command line.

### Run it

```bash
npx oxlint --config node_modules/@sebastienrousseau/oxlint-config/.oxlintrc.json .
```

### Or copy it in

```bash
cp node_modules/@sebastienrousseau/oxlint-config/.oxlintrc.json ./.oxlintrc.json
```
...
`@sebastienrousseau/oxlint-config` is a focused satellite of the [`@sebastienrousseau/config`](https://github.com/sebastienrousseau/config) suite — a unified ecosystem of 21 single-purpose, zero-overhead developer configurations designed to share a single design philosophy, strict typing, and zero runtime dependencies.
...
`@sebastienrousseau/oxlint-config` solves this with three deliberate engineering choices:
...
When you require full AST-transforming codemods or auto-fixing rules that are not yet implemented in the Oxlint Rust engine.
