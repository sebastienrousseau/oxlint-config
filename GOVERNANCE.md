...
This document describes how @sebastienrousseau/oxlint-config is run: who decides what, how
...
@sebastienrousseau/oxlint-config is **maintainer-led**. As of the current release line it has a single
